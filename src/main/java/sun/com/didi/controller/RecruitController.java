...
public class RecruitController {
    ...
    public String Unit(HttpServletRequest request, HttpServletResponse response,String Rec_company, String Rec_category, String Rec_salary, String Rec_Duration, String Rec_experience){
