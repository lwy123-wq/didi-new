...
public class JobServiceImpl extends JobDao {
    ...
    public int insertJob(String name,String phone,String id_code,String card,String school,String email,String marriage,String address,String city,int years,String education){
